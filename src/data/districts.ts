...
export const STATE_CITIES: Record<string, string[]> = {
  'Andhra Pradesh': [
    ...
    'Vizianagaram', 'West Godavari', 'YSR Kadapa', 'Eluru', 'Kakinada', 
    'Konaseema', 'Manyam', 'NTR', 'Palnadu', 'Tirupati', 'Anakapalli', 
    'Bapatla', 'Nandyal', 'Sri Sathya Sai', 'Annamayya', 'Parvathipuram Manyam'
  ],
  'Arunachal Pradesh': [
    ...
    'Shi Yomi', 'Tawang', 'Tirap', 'Upper Dibang Valley', 'Upper Siang', 
    'Upper Subansiri', 'West Kameng', 'West Siang', 'Itanagar'
  ],
  'Assam': [
  ...
  'Manipur': [
    ...
    'Senapati', 'Tamenglong', 'Tengnoupal', 'Ukhrul', 'Thoubal'
  ],
  'Meghalaya': [
  ...
  'West Bengal': [
    ...
    'Paschim Medinipur', 'Paschim Bardhaman', 'Purba Bardhaman', 'Purba Medinipur', 
